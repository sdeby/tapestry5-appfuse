...
import org.appfuse.webapp.components.HashedPasswordField;
...
public class UserForm implements ClientElement {
		...
		@Component(id = "confirmPassword", 
			       parameters = {"value=user.confirmPassword", "validate=required", })
		private HashedPasswordField confirmPasswordField;
		
		@Component(id = "passwordHint", 
				   parameters = { "value=user.passwordHint","validate=required", })
		private TextField passwordHintField;

		@Component(id = "firstName", 
				   parameters = { "value=user.firstName","validate=required", })
		private TextField firstNameField;

		@Component(id = "lastName", 
				   parameters = { "value=user.lastName","validate=required", })
		...
		@Component(id = "phoneNumber", 
			       parameters = { "value=user.phoneNumber","validate=minlength=11", })
		private TextField phoneNumberField;

		@Component(id = "website", 
				   parameters = { "value=user.website", "validate=required", })
		private TextField websiteField;

		@Component(id = "address", 
				   parameters = { "value=user.address.address", })
		private TextField addressField;

		@Component(id = "city", 
				   parameters = { "value=user.address.city","validate=required", })
		private TextField cityField;

		@Component(id = "state", 
				   parameters = { "value=user.address.province","validate=required", })
		private TextField stateField;

		@Component(id = "postalCode", 
				   parameters = {"value=user.address.postalCode", "validate=required", })
